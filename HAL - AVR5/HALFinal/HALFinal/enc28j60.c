...
#define ENC28J60_CONTROL_SO 3
#define ENC28J60_CONTROL_SI 2
#define ENC28J60_CONTROL_SCK 1

// set CS to 0 = active
#define CSACTIVE ENC28J60_CONTROL_PORT &= ~_BV(ENC28J60_CONTROL_CS)
// set CS to 1 = passive
#define CSPASSIVE ENC28J60_CONTROL_PORT |= _BV(ENC28J60_CONTROL_CS)
//
...
void enc28j60Init(uint8_t* macaddr)
{
	...
	CSPASSIVE; // ss=1
        //	
	ENC28J60_CONTROL_DDR  |= _BV(ENC28J60_CONTROL_SI) | _BV(ENC28J60_CONTROL_SCK); // mosi, sck output
